    ...
    <div className="hero-glow min-h-screen py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center animate-fade-in">
          <p className="mb-3 text-sm font-bold uppercase tracking-[0.3em] text-primary">Publish</p>
          <h1 className="mt-2 text-4xl font-extrabold text-slate-900 sm:text-5xl">
            Add a recording to Lumina
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-slate-600">
            Videos go to Cloudinary, metadata is saved in Supabase PostgreSQL.
          </p>
        </div>
