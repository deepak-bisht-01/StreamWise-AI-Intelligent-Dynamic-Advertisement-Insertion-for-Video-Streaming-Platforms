    ...
    <label className="block" htmlFor={id}>
      ...
      <div className="relative">
        <textarea
          id={id}
          rows={rows}
          className={`w-full resize-y rounded-xl border-2 bg-white px-4 py-3 text-sm text-slate-800 outline-none transition-all duration-200 placeholder:text-slate-400 focus:ring-4 ${errorClass} ${className}`}
          {...props}
        />
      </div>
